...
<!--[if gt IE 8]><!--> <html lang="de"> <!--<![endif]-->
    <head>
        ...
        <title>Freifunk Euskirchen</title>
        <meta name="description" content="Freifunk Euskirchen ist dein freies WLAN zum selber machen, in Euskirchen.">
    ...
    <body>
            ...
            <header id="main-header">
                ...
                <nav class="main-navigation">
                    <ul onclick="<?php /* Fixes missing hover effect on iOS */?>">
                        ...
                        <li><a href="http://map.ffeu.de/">Karte</a></li>
        ...
        <main>
            ...
            <figure id="participate" class="section-image">
                <img src="media/freifunk-flensburg-routerhafenspitze-by-fabian-horst.jpg" alt="Freifunk Euskirchen - Router an der Hafenspitze">
                <figcaption>
            ...
            <figure id="faq" class="section-image">
                <img src="media/freifunk-flensburg-fragen-by-fabian-horst.jpg" alt="Freifunk Euskirchen - Mit den richtigen Antworten">
                <figcaption>
            ...
            <figure id="donate" class="section-image">
                <img src="media/freifunk-flensburg-spenden.jpg" alt="Spenden an Freifunk Euskirchen">
                <figcaption>
            ...
            <figure id="contact" class="section-image">
                <img src="media/freifunk-flensburg-kontakte.jpg" alt="Basteln beim Freifunk Euskirchen">
                <figcaption>
